...
class PoseEKF:
    ...
    def update(
        ...
        *,
        ...
        mahalanobis = float(np.sqrt(max(0.0, innovation @ solved_innovation)))
        ...
        identity_minus_gain_h = np.eye(7) - gain @ self.observation_matrix
        self.covariance = (
            identity_minus_gain_h @ self.covariance @ identity_minus_gain_h.T
