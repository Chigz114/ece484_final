...
from quadpilot.datasets.gate_sampling import (  # noqa: E402
    GateFocusConfig,
...
DEFAULT_RUNS = {
    ...
    "lemniscate": REPOSITORY_ROOT / "outputs/lemniscate/splatfacto/2025-05-09_153156",
}
EXPECTED_ASSETS = {
    "circle": {
        "step": 29999,
...
GENERATION_CODE_PATHS = (
    ...
    REPOSITORY_ROOT / "src" / "quadpilot" / "datasets" / "gate_sampling.py",
    REPOSITORY_ROOT / "src" / "quadpilot" / "perception" / "renderer.py",
    REPOSITORY_ROOT / "src" / "quadpilot" / "simulation" / "tracks.py",
)
