...
from quadpilot_repro.evaluation import evaluate_ordered_gates  # noqa: E402
from quadpilot_repro.tracks import TRACKS, TrackConfig, get_track  # noqa: E402
...
def verify_closed_loop_output(
    ...
    *,
    ...
    track: str = "circle",
    manifest_path: str | Path = REPOSITORY_ROOT / "repro_assets" / "manifest.json",
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--manifest",
        type=Path,
        default=REPOSITORY_ROOT / "repro_assets" / "manifest.json",
    )
