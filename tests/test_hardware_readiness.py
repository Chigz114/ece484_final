...
from quadpilot_repro.hardware import (
...
class HardwareReadinessTests(unittest.TestCase):
    ...
    def test_template_is_blocked(self) -> None:
        template = Path(__file__).resolve().parents[1] / "repro_env" / "hardware-preflight.template.json"
    ...
    def test_complete_prop_off_fixture_is_ready(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            config = {
                ...
                "timeouts_s": {"pose": 0.1, "image": 0.2, "setpoint": 0.2, "command": 0.1},
