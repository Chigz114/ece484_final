...
from scripts import reproduce_npe_closed_loop as closed_loop_cli
from quadpilot_repro.estimation import PoseEKF
from quadpilot_repro.npe import PoseNormalizer
from quadpilot_repro.simulation import run_oracle_simulation
from quadpilot_repro.tracks import TRACKS
from quadpilot_repro.visual_loop import (
    TorchNPEPredictor,
...
class OracleEquivalenceTests(unittest.TestCase):
    ...
    def test_shared_renderer_starts_raw_and_ekf_from_identical_sensor_sample(self) -> None:
        ...
        raw = run_visual_closed_loop(
            "circle", renderer=renderer, predictor=predictor, estimator="raw", max_steps=2
        )
...
class ClosedLoopCliContractTests(unittest.TestCase):
    ...
    def test_default_circle_renderer_assets_follow_the_recovered_manifest(self) -> None:
        ...
        run_dir = (
            closed_loop_cli.REPOSITORY_ROOT
            / "outputs"
            / "circle"
            / "splatfacto"
            / "2025-05-09_144210"
...
class InjectionAndSafetyTests(unittest.TestCase):
    ...
    def test_nonfinite_ekf_diagnostic_fails_before_control_and_remains_saveable(self) -> None:
